...
// autismo tablets no tab
	var/list/bombs = list(
		...
		list("name"="Impact grenade (poison)",  "type"=/obj/item/impact_grenade/smoke/poison_gas, "price"=50),
		list("name"="Impact grenade (healing)", "type"=/obj/item/impact_grenade/smoke/healing_gas,"price"=50),
		list("name"="Impact grenade (fire)",    "type"=/obj/item/impact_grenade/smoke/fire_gas,   "price"=50),
		list("name"="Impact grenade (blind)",   "type"=/obj/item/impact_grenade/smoke/blind_gas,  "price"=50),
		list("name"="Impact grenade (mute)",    "type"=/obj/item/impact_grenade/smoke/mute_gas,   "price"=50),
